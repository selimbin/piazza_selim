...
import org.piazza.commands.SendNotificationSingleTokenCommand;
...
//        String commandPath = "org.piazza.commands.SendNotificationSingleTokenCommand";
//        Class<?> commandClass = Class.forName(commandPath);
//        SendNotificationSingleTokenCommand command = (SendNotificationSingleTokenCommand) commandClass.getConstructor().newInstance();
//        commandHashMap.put("SendNotificationSingleTokenCommand", command);
